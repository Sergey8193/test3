...
public class OrderHistoryPage extends AccountBasePage {
    ...
    public static final By LI_HISTORY_LIST_ITEM_CONTAINER = By.xpath(".//li[@class='OrderHistory_listItem__2x95r mb-6']");
...
//    public static final By DIV_ = By.xpath(".//div[@class='']");
    ...
    @Step("Get 'Order time'")
    public String getOrderTime(WebElement order) {
        return getOrderPropertyValue(order, P_HISTORY_LIST_ITEM_TIME);
    }
    ...
    public String getOrderStatus(WebElement order) {
        return getOrderPropertyValue(order, P_HISTORY_LIST_ITEM_STATUS);
    }

    @Step("Get 'Order price'")
    public Integer getOrderPrice(WebElement order) {
        return Integer.valueOf(getOrderPropertyValue(order, P_HISTORY_LIST_ITEM_PRICE));
    }
}
