...
public class OrderHistoryPageParamTest extends BaseTest {
    ...
    public void checkThatExistentUserOrderHistoryListContainsSpecificOrder() {
        ...
        isOrdersNotEmpty = !getOrdersSuccessInfo.getOrders().isEmpty();

        final Integer EXPECTED_ORDER_TRACK = isOrdersNotEmpty ? order.getNumber() : null;
        final String EXPECTED_ORDER_NAME = isOrdersNotEmpty ? order.getName() : null;
